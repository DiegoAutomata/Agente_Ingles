export const LEAGUES = [
  ...
  { id: 'diamante',     name: 'Diamante',     icon: '💎', color: '#7dd3fc', levels:  8 },
  { id: 'maestro',      name: 'Maestro',      icon: '👑', color: '#a855f7', levels:  8 },
  { id: 'gran_maestro', name: 'Gran Maestro', icon: '🏆', color: '#ef4444', levels:  6 },
] as const
